...
namespace Plenum
{
    ...
    internal abstract class JohnsonSidePanel : Part
    {
        ...
        internal double THK { get; set; } = SidePanel.THK;
        ...
        // Constructor
        protected JohnsonSidePanel(CallerType callerType) : base(callerType) { }
        ...
        protected override void EditDimensions(ModelDoc2 modelDoc2)
        {
            ...
            mTools.EditDimension("Hole5", "sk:Hole", Depth + 1, modelDoc2);
            ...
            mTools.EditDimension("FlangeWidth", "sk:ColumnCut", Beam.FlangeWidth + mTools.AssemblyClearance * 2, modelDoc2);
            ...
            mTools.HolePattern(Johnson.ExtraLength - Beam.FlangeWidth / 2 - mTools.AssemblyClearance - mTools.InterferenceClearance - HoleToEdge * 2, out double countExtra, out double spacingExtra);
            ...
            mTools.HolePattern(Length / FanCount - Beam.FlangeWidth - mTools.AssemblyClearance * 2 - HoleToEdge * 2, out double count, out double spacing);
