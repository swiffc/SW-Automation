...
Public Class hpc60xP
''' Contains the instructions typical for the
''' 60xP Template -> Header 'x' Weldment Base Part
...
#End Region
    ...
    Public Sub Main()
      ...
      Call SetStdNumber()
      Call PrefixParameterNames( ThisDoc.Document.ComponentDefinition.Parameters ,
                                 "dH1" , "dH_" )
    ...
    ''' <remarks></remarks>
    Sub SetStdNumber(Optional ByVal sID As String = "60xP")
